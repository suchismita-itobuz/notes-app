...
export default function ExistingUser() {
    ...
    return (
        <div className="flex justify-center align-center">
            <form onSubmit={handleSubmit(submitForm)} className=" w-[300px] first_bp:w-[350px] second_bp:w-[400px] md:[w-743px] bg-[#f2a41f] rounded shadow-xl p-[20px] m-[50px] md:mt-[70px] lg:mt-[120px]">
                ...
                <div className="flex mb-[20px] justify-center">
                    <button className="text-md md:text-lg bg-[#FFD689] hover:bg-amber-700 hover:text-white p-[5px] px-[10px] rounded lg:mt-[92px]" >Submit</button>
